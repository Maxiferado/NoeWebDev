...
<body>
    ...
    <header>
        ...
        <h1>
            ...
            <div id="contenedorLogo">
                <a href="index.html">
                    <figure><img src="/media/logoNoe/Noelogo (2).png" alt="LogoNoe"></figure>
                </a>
            </div>
    ...
    <div class="swiper-container swiper2">
        <div class="swiper-wrapper swiper-wrapper2">
            <div class="swiper-slide swiper-slide2">
                <div class="imgBx"><img src="/media/marcasConcentrado/logo-coca-cola.png" alt=""></div>
            </div>
            <div class="swiper-slide swiper-slide2">
                <div class="imgBx"><img src="/media/marcasConcentrado/logo-godrej.png" alt=""></div>
            </div>
            <div class="swiper-slide swiper-slide2">
                <div class="imgBx"><img src="/media/marcasConcentrado/logo-oppo.png" alt=""></div>
            </div>
            <div class="swiper-slide swiper-slide2">
                <div class="imgBx"><img src="/media/marcasConcentrado/logo-paypal.png" alt=""></div>
            </div>
            <div class="swiper-slide swiper-slide2">
                <div class="imgBx"><img src="/media/marcasConcentrado/logo-philips.png" alt=""></div>
            </div>
        </div>
        <!-- Add Pagination -->
        <div class="swiper-pagination"></div>
